namespace LDVELH_WindowsForm
{
    ...
    public class StoryContext : DbContext
    {
        ...
        public DbSet<Story> MyStories { get; set; }
        public DbSet<BackPack> MyBackPacks { get; set; }
        public DbSet<Character> MyCharacters { get; set; }
        public DbSet<Ennemy> MyEnnemies { get; set; }
